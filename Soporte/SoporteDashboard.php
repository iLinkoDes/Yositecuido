<?php
require('../php/sub-redirects/sop-redirect.php');
	
?>
<!doctype html>
<html>
<head>
	<title>#YoCuidoDeTi - Soporte Dashboard</title>
	<meta charset="utf-8">
	...
	<div class="container-full top-bar">
		<nav class="navbar navbar-light" style="min-height: 85px;">
		  <a id="logo" class="navbar-brand ml-5" href="SoporteDashboard.php">
		    #YoCuidoDeTi
		  </a>
		  <p class="navbar-brand pr-5 mb-0 ">Panel de Soporte</p>
	...
	<div class="container-full all-container">
		<div class="d-flex row p-5" id="wrap-contenido">
			<div class="col-10 mx-auto py-3 px-4">
				<h2 class="text-center">Contenido para Soporte</h2>
